    ...
    <>
      <header className="flex h-[70px] bg-white items-center justify-around shadow-md p-4 border-t-4 border-green-700">
        ...
        <div className="flex items-center gap-6">
          ...
          <span className="text-black font-bold text-2xl drop-shadow-lg font-roboto">T-Load</span>
        </div>
          ...
          <nav className="relative">
            ...
            {isDropdownOpen && (
              <ul className="absolute right-0 mt-2 w-48 bg-white text-black rounded-md shadow-lg">
                <li className="p-2 hover:bg-gray-100 cursor-pointer">메뉴 1</li>
                <li className="p-2 hover:bg-gray-100 cursor-pointer">메뉴 2</li>
                <li className="p-2 hover:bg-gray-100 cursor-pointer">메뉴 3</li>
              </ul>
            )}
          </nav>
